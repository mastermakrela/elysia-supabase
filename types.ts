/**
 * This file is copied 1 to 1 from https://jsr.io/@supabase/supabase-js/2.48.1/src/lib/types.ts#L95
 * Because jsr doesn't allow me to import the files otherwise
 */

import { AuthClient } from "npm:@supabase/auth-js@2.67.3";
import { RealtimeClientOptions } from "npm:@supabase/realtime-js@2.11.2";
import { PostgrestError } from "npm:@supabase/postgrest-js@1.18.1";
